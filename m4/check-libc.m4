...
AC_CHECK_FUNCS([getprogname vsyslog vsyslog_r])
...
AM_CONDITIONAL([HAVE_VSYSLOG], [test "x$ac_cv_func_vsyslog" = xyes])
AM_CONDITIONAL([HAVE_VSYSLOG_R], [test "x$ac_cv_func_vsyslog_r" = xyes])
])
